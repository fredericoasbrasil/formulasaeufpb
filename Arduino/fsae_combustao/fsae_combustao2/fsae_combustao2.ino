...
void setup() {
  ...
  Serial.println("DiaMesAno;HoraMinutosSegundos;Latitude;Longitude;Velocidade;Altitude;Satelites;GyroX;GyroY;GyroZ;AcelerometroX;AcelerometroY;AcelerometroZ");
  delay(300);
